...
const Breadcrumbs: React.FC<BreadcrumbsProps> = ({
  ...
  return <nav className="flex items-center justify-between mx-auto ">
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
      ...
      {backButton && <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-white" asChild>
